...
public class MandelbrotMain {
    ...
    public static final String DESCR =
            "Demonstrates a distributed farmer/worker/harvester parallelisation. \nThe farmer and harvester processes " +
                    ...
                    "\nThe use of a real Tcp/IP network is indicated by running the main process with the argument -external.";
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Get arguments
        boolean realNetwork = false; // assume running on loop back network
