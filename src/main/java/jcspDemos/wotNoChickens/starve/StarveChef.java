 ...
 * @author P.H. Welch
 */
class StarveChef implements CSProcess {
  ...
  private final StarveCanteen.Supply supply;

  public StarveChef (String id, int batchSize, int batchTime, StarveCanteen.Supply supply) {
    this.id = id;
